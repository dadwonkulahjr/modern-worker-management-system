...
namespace WorkerModernManagementSystem.UI.Migrations
{
    public partial class AddingInitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Employee",
                columns: new[] { "Id", "DateHire", "Office Email", "FirstName", "Image", "LastName", "Salary" },
                values: new object[,]
                {
                    { 1, new DateTime(2021, 6, 24, 18, 44, 44, 144, DateTimeKind.Local).AddTicks(2389), "iamtuse@iamtuse.com", "iamtuse", "~/images/Iam_Tuse_Seven.jpg", "theProgrammer", 450000m },
                    { 2, new DateTime(2021, 6, 24, 18, 44, 44, 148, DateTimeKind.Local).AddTicks(7692), "tom@iamtuse.com", "Tom", "~/images/david.png", "Hasting", 50000m },
                    { 3, new DateTime(2021, 6, 24, 18, 44, 44, 148, DateTimeKind.Local).AddTicks(7777), "iren@iamtuse.com", "Iren", "~/images/sara.png", "Collins", 25000m }
                });
